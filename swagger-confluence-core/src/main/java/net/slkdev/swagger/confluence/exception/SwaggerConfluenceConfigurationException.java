...
public class SwaggerConfluenceConfigurationException extends RuntimeException {
    ...
    public SwaggerConfluenceConfigurationException() {
        super();
    }
    ...
    public SwaggerConfluenceConfigurationException(Throwable cause) {
        super(cause);
    }

    protected SwaggerConfluenceConfigurationException(String message, Throwable cause,
